...
// options passed: -mgeneral-regs-only -mlittle-endian -mabi=lp64 -g -g -ffreestanding -fomit-frame-pointer -fasynchronous-unwind-tables -fstack-clash-protection
	.text
.Ltext0:
	.file 0 "/home/mlbo/claude/arm64_programming_practice/chapter_21/lab21-3/benos" "arch/arm64/kernel/asm-offsets.c"
	.align	2
	.global	main
	.type	main, %function
main:
...
->THREAD_CPU_CONTEXT 16 offsetof(struct task_struct, cpu_context)	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:58: 	DEFINE(TI_PREEMPT,  offsetof(struct task_struct, preempt_count));
	.loc 1 58 2
// 58 "arch/arm64/kernel/asm-offsets.c" 1
	
->TI_PREEMPT 148 offsetof(struct task_struct, preempt_count)	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:59: 	DEFINE(NEED_RESCHED, offsetof(struct task_struct, need_resched));
	.loc 1 59 2
// 59 "arch/arm64/kernel/asm-offsets.c" 1
	
->NEED_RESCHED 144 offsetof(struct task_struct, need_resched)	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:60: 	return 0;
	.loc 1 60 9
#NO_APP
	mov	w0, 0	// _1,
// arch/arm64/kernel/asm-offsets.c:61: }
	.loc 1 61 1
	ret	
	.cfi_endproc
.LFE13:
...
.LASF1:
	.string	"/home/mlbo/claude/arm64_programming_practice/chapter_21/lab21-3/benos"
.LASF0:
